...
1. Artigo: Data Organization in Spreadsheets
2. Armazenamento de Números em Computadores
3. Tipos de Dados em Finanças



## Artigo: Data Organization in Spreadsheets - Karl W. Broman e Kara H. Woo

### 1. Introdução 

- Os perigos das planilhas são reais
...
### Recomendações práticas para organizar os dados da planilha de uma forma que tanto os humanos quanto os programas de computador possam ler.


2. Seja Consistente


3. Escolha Bons Nomes para as Variáveis


4. Escreva dadas conforme a Norma ISO 8601


5. Sem Células Vazias


6. Coloque Apenas um Valor nas Células


7. Crie um Retângulo 

    - [Tidy Data](https://r4ds.hadley.nz/data-tidy.html#sec-tidy-data)
...
8. Crie um Dicionário dos Dados


9. Sem Cálculos nos Arquivos dos Dados Brutos


10. Não Use Cor na Fonte ou Realce como dados


11. Faça Backups


12. Use Validação dos Dados para Evitar Erros


13. Salve os Dados em Arquivos de Texto Simples
...
- A constante `double.eps` representa o menor número positivo que pode ser representado no tipo `double` antes que a precisão seja perdida:

```{r, echo=TRUE}
abs((0.3 - 0.2) - 0.1) < .Machine$double.eps
```

- Ou seja, a precisão padrão da linguagem R (e náo apenas da linguagem R) é de 53 bits (dígitos binários), o que equivale a cerca de 15 ou 16 dígitos 
decimais.
...
Segundo @munnell O Home Mortgage Disclosure Act foi promulgado para monitorar o acesso de minorias de baixa renda ao mercado de hipotecas. Os dados 
...
Utilizando o pacote `correlationfunnel`: 
...
Estes dados foram utilizados no artigo de @maia2018. Os autores  
