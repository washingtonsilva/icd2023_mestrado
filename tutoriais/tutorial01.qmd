...
a partir do menu. Você pode criar um projeto totalmente novo, um projeto de um diretório existente ou um projeto com controle de versão (veja o [Git e Github tutorial](https://kbroman.org/github_tutorial/) para detalhes). Neste tutorial vamos criar um projeto em um novo diretório (ou pasta).
...
A menos que você esteja fazendo algo realmente rápido e sujo, sugiro que você sempre escreva seu código R como um script oR. Os scripts R são o que torna o R tão útil. Você não apenas tem um registro completo de sua análise, desde a manipulação de dados, visualização e análise estatística, como também pode compartilhar esse código (e dados) com colegas e, principalmente, quando envia e publica sua pesquisa em um periódico. 

Com isso em mente, certifique-se de incluir em seu script R todas as informações necessárias para tornar seu trabalho reprodutível (nomes dos autores, datas, design de amostragem, etc.). Essas informações podem ser incluídas como uma série de comentários `#` ou, ainda melhor, misturando código executável com narrativa 
em um `R Notebook`, `R markdown` ou `quarto` . 
...
# Titulo: Análise de séries temporais de snouters

# Finalidade: Este script executa uma análise de série temporal nos dados de 
# contagem de baleias 

# Os dados consistem em contagens de espécies de baleias coletadas em 18 ilhas
# no arquipélago Hy-yi-yi entre 1950 e 1957.

# Número do projeto: #007

# Arquivo de dados: '/Users/Another/snouter_analysis/snouter_pop.txt'

# Autor: Washington S. Silva
# Detalhes de contato: wsilva@gmail.com
