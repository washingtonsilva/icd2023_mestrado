...
Use as informações disponibilizadas para obter uma estimativa pontual de 
$p$.
...
proporção de faturas com erro seja superior a 50%? Responda observando o 
valor-p do teste: $H_0: p = 0.5$ versus $H_A: p > 0.5$. 

Interprete o resultado do teste seguindo o padrão da APA.


### Questão 1.3

Obtenha um intervalo com 95% de confiança para $p$ utilizando o estimador por 
intervalo baseado no Teorema Central do limite.


### Questão 1.4

Obtenha um intervalo com 95% de confiança para $p$ utilizando 
bootstrap não-paramétrico.


### Questão 1.5

Em suas palavras, por que um intervalo de confiança contém mais informações 
...
significativamente diferente de zero. O resultado obtido para a Oracle suporta 
ou não a previsão do CAPM?
...
**a.** faça um gráfico de dispersão entre os retornos excedentes do índice S&P 
(500), no eixo x, e os retornos excedentes da oracle, no eixo y. Além disso, 
inclua a reta de regressão estimada (linha característica) no gráfico. 
Observando esse gráfico de dispersão, Qual sua conclusão sobre a validade do 
modelo linear proposto pelo CAPM?

**b.** Efetue o teste RESET para testar formalmente a adequação do modelo linear. 
...
Interprete o $R^2$-ajustado do modelo estimado.


### Questão 2.4

Efetue o teste de Jarque-Bera de normalidade dos resíduos do modelo, use 
...
Descreva brevemente as as consequências do resultado.
